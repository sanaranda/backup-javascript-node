...
switch (comando1) {
    case 'listar':
        ...
        tareas.forEach((elemento,i) => {    //se puede pasar el index como segundo parametro en forEach
            console.log("Titulo tarea numero " + (i+1) + " = " + elemento.titulo)
        });
    break;
    
    case 'filtrar':                                                    // si en vez de poner listar pongo filtrar y luego el estado, me lista todas las tareas con ese estado
        if((comando2 != 'pendiente') && (comando2 != 'en_progreso') && (comando2 != 'terminada') && (typeof comando2 != 'undefined')){
    ...
    case 'crear':
        ...
        funciones.escribirJSON(tareasJson);                            // ahora que esta en Json, pisar el archivo tareas.json viejo
        }else{
